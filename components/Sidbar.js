...
import { BellIcon,BookmarkIcon, DotsCircleHorizontalIcon, HashtagIcon, HomeIcon, InboxIcon ,ClipboardIcon,UserIcon} from '@heroicons/react/solid'
...
export default function Sidbar() {
  return (
    <div>
        ...
        {/* Menu */}
        <div className="">
            <SidbarMenuItem text="خانه" Icon={HomeIcon} />
            <SidbarMenuItem text="جستجو" Icon={HashtagIcon} />
            <SidbarMenuItem text="اطلاعیه ها" Icon={BellIcon} />
